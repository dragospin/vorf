...
if __name__ == '__main__':
    ...
    for e in range(config.NUM_EPOCHS):
        ...
        plots['Training loss'].append(train_loss.item())
        plots['Training class accuracy'].append(train_acc)

        plots['Validation loss'].append(val_loss.item())
        ...
        if e >= 1 and val_acc > prev_val_acc or (val_acc == prev_val_acc and val_loss < prev_val_loss):
            prev_val_acc = val_acc
            prev_val_loss = val_loss
    ...
    plt.figure()
    plt.plot(plots['Training loss'],'o', ls='-', ms=4, markevery=None, linewidth=2.0,label='training loss')
    plt.plot(plots['Training class accuracy'],'o', ls='-', ms=4, markevery=None, linewidth=2.0,label='Accuracy')
